...
export function Footer() {
  return <Box component="footer" sx={{ bgcolor: '#061426', color: 'white', pt: 8 }}>
    <Container><Grid container spacing={5}>
      ...
      <Grid size={{ xs: 12, md: 2 }}><Typography fontWeight={900} mb={2}>Contact</Typography><Typography color="rgba(255,255,255,.68)">21902 State Road 46<br />Mount Dora Florida 32757</Typography><Typography component="a" href="tel:8889914776" color="white" fontWeight={900} display="block" mt={2}>(888) 991-4776</Typography></Grid>
